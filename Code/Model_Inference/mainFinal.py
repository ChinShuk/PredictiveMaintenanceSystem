...
# Load Pickle Model
MODEL_PATH = "random_forest_predictiveMaintainance.h5"  # Update the path to your .pkl file
        ...
        try:
            ...
            if len(data_x) >= 50:
                ...
                if features:
                    ...
                    features['fftx'] = fft_x.tolist()
                    features['ffty'] = fft_y.tolist()
                    features['fftz'] = fft_z.tolist()
                    ...
                    if inference_input.shape[1] == 7:  # Validate input shape
                        ...
                        features['prediction'] = predicted_label
