        ...
        try:
            ...
            if len(data_x) >= 50:
                ...
                if features:
                    ...
                    # Select one value for each vibration axis and FFT data
                    selected_vx = str(data_x[0])
                    selected_vy = str(data_y[0])
                    selected_vz = str(data_z[0])
                    selected_fftx = str(fft_x[0])
                    selected_ffty = str(fft_y[0])
                    selected_fftz = str(fft_z[0])
                    ...
                    if inference_input.shape[1] == 7:  # Validate input shape
                        ...
                        # Prepare JSON payload with one value for each axis and FFT
                        payload = {
